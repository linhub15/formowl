...
export function Tabbar(
  ...
  return (
    <nav
      {...props}
      className={cn(className, "flex flex-1 items-center gap-4 -ml-2 py-4")}
    />
  );
}
...
export function TabbarItem(
  ...
  const classes = cn(
    // Base
    "relative flex min-w-0 items-center gap-3 rounded-lg p-2 text-left text-base/6 font-medium text-zinc-950/80 sm:text-sm/5",
